...
import FavIcon2 from "../../public/favicon2.ico"
        ...
        <DropdownMenuLabel className="flex items-center justify-between">
          <div className="flex space-x-2">
            <Link
              ...
              href="https://trynyro.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Image src={FavIcon2} width={25} alt="FavIcon2" />
            </Link>

            <Link
              className="cursor-pointer hover:opacity-50"
              href="https://x.com/trynyro"
              target="_blank"
              rel="noopener noreferrer"
            >
              <IconBrandX />
            ...
            <Link
              className="cursor-pointer hover:opacity-50"
              href="https://discord.gg/eQ5JRUVCgp"
              target="_blank"
              rel="noopener noreferrer"
            >
              <IconBrandDiscord />
